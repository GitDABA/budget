  ...
  return (
    <div className={`${className}`}>
      ...
      <AnimatedContainer delay={0.1}>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-soft p-6 mb-6 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <AnimatedContainer delay={0.15} variant="slideUp">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-soft p-5 relative overflow-hidden">
            ...
            <div className="flex justify-between">
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold mt-1 text-gray-800 dark:text-gray-200">
